...
**NOTE**: please don't hide changes to this file in a "generated changes" commit, treat it as sampl.source code instead.

## API testing sheet
.
__🥝__
//obj.str ~ webhook group.xyz
>>ajs
>>cicifuj
>>badAutonomousAction
//parses bot.commands on-top-of/overwriting api-rules
.
* hidden segmentations
* en-crypted
* tagged feature
//stand-parcel-hiddSegmLayer
